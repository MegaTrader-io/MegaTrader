...
class Label
{
    ...
    public const CHECKOUT_META = [
        "create_account_title" => "OR, CREATE A NEW ACCOUNT",
    ...
    public const META_ACCOUNT_OVERVIEW = [
        ...
        "performance_trading_days" => "Total Trading Days",
        "performance_current_equity" => "Current Equity",
        "performance_highest_profit_day" => "Highest Profit Day",
        ...
        "performance_consistency_title" => "Consistency Rule",
        "performance_consistency_description" => "Prevents a single trading day from accounting for too much of your total profit, encouraging steady and balanced trading behavior.",
        "forex_consistency_performance_consistency_title" => "Performance Reliability Score (PRS)",
        "forex_consistency_performance_consistency_description" => "Measures the consistency and reliability of a trader’s performance over time, promoting disciplined risk management and stable trading behavior rather than short-term or irregular results.",
        ...
        "performance_dll_tooltip_description" => "The maximum loss allowed in a single trading day. If your net PnL reaches this limit, trading is restricted for the remainder of the day to prevent further losses.",
