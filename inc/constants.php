...
class Label
{
    ...
    public const META_ACCOUNT_OVERVIEW = [
        ...
        "futures_performance_consistency_title" => "Performance Reliability Score (PRS)",
        "futures_performance_consistency_description" => "Measures the consistency and reliability of a trader’s performance over time, promoting disciplined risk management and stable trading behavior rather than short-term or irregular results.",
