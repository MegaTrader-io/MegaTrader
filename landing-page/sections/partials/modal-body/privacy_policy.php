    ...
    <div class="pl-8">
        <ul class="list-disc text-stone-400 space-y-2">
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal">
                <span class="font-bold text-stone-300">Identity Information</span>: Your full name,
                email address, country of residence, and username or password credentials.
            </li>
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal">
                <span class="font-bold text-stone-300">Technical Information</span>:
            ...
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal">
                <span class="font-bold text-stone-300">Usage Data</span>: Simulated trades, session
            ...
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal"><span
                        class="font-bold text-stone-300">Communications</span>: Chat transcripts, emails,
...
<div class="space-y-4">
    ...
    <div class="pl-8">
        <ul class="list-disc text-stone-400 space-y-2">
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal">
                <span class="font-bold text-stone-300">Authenticate and Manage Accounts</span>:
                Ensuring secure login access, verifying identities, and enabling account recovery.
            </li>
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal">
                <span class="font-bold text-stone-300">Deliver Platform Features</span>: Running
                simulations, storing trading metrics, awarding rewards, and presenting personalized
                content.
            </li>
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal"><span
                        class="font-bold text-stone-300">Enable Communication</span>: Sending service
                updates, responding to support requests, or delivering reminders, offers, and
                notifications (where applicable).
            </li>
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal"><span
                        class="font-bold text-stone-300">Monitor and Improve Services</span>: Tracking
                performance bottlenecks, crash data, platform usability, and user engagement analytics.
            </li>
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal"><span
                        class="font-bold text-stone-300">Ensure Compliance and Detect Abuse</span>:
...
<div class="space-y-4">
    ...
    <div class="pl-8">
        <ul class="list-disc text-stone-400 space-y-2">
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal">
                <span class="font-bold text-stone-300">Payment Processors</span>:
                To handle transactions, prevent fraud, and verify purchases (e.g., Stripe or
                cryptocurrency gateways).
            </li>
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal">
                <span class="font-bold text-stone-300">Analytics and Tracking Providers</span>:
                Services like Google Analytics help us understand platform performance and user
                behavior.
            </li>
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal">
                                <span
                                        class="font-bold text-stone-300">Cloud Infrastructure and Storage Services</span>:
                Used for hosting, backups, and database operations (e.g., AWS, Firebase).
            </li>
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal"><span
                        class="font-bold text-stone-300">Security and Fraud Monitoring Tools</span>: To
                detect abuse, account sharing, bot activity, or other violations.
            </li>
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal"><span
                        class="font-bold text-stone-300">Legal and Regulatory Authorities</span>:
...
<div class="space-y-4">
    ...
    <p class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal">
        If you detect suspicious activity, please notify us immediately at <a
                ...
                class="text-[#ffb54d]">support@megatrader.io</a> so we
...
<div class="space-y-4">
    ...
    <div class="pl-8">
        <ul class="list-disc text-stone-400 space-y-2">
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal">
                <span class="font-bold text-stone-300 mr-1">Live Chat</span>
                on our platform, or
            </li>
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal">
                <span class="font-bold text-stone-300">Email</span>:
                <a href="mailto:support@megatrader.io"
                   class="text-[#ffb54d] ml-1">support@megatrader.io</a>
            </li>
        </ul>
    </div>
    <p class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal">
...
<div class="space-y-4">
    ...
    <div class="pl-8">
        <ul class="list-disc text-stone-400 space-y-2">
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal">
                <span class="font-bold text-stone-300">Essential Cookies</span>:
                Required for core site functions like authentication, fraud detection, and session
                persistence.
            </li>
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal">
                <span class="font-bold text-stone-300">Performance Cookies</span>:
                Collect data on how users interact with the platform to optimize layout, speed, and
                accessibility.
            </li>
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal">
                                <span
                                        class="font-bold text-stone-300">Functional Cookies</span>:
                Store language preferences, user settings, and UI personalization details.
            </li>
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal"><span
                        class="font-bold text-stone-300">Marketing Cookies (opt-in only)</span>: Help us
...
<div class="space-y-4">
    ...
    <div class="pl-8">
        <ul class="list-disc text-stone-400 space-y-2">
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal">
                <span class="font-bold text-stone-300">Material Changes</span>:
            ...
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal">
                <span class="font-bold text-stone-300">Minor or Technical Edits</span>:
                Updates that clarify language, restructure content, or revise terminology will be posted
                without separate notification.
            </li>
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal">
                                <span
                                        class="font-bold text-stone-300">Version Control</span>:
...
<div class="space-y-4">
    ...
    <div class="pl-8">
        <ul class="list-disc text-stone-400 space-y-2">
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal">
                <span class="font-bold text-stone-300">Live Chat Support</span>:
                Available directly on the MegaTrader website or user dashboard. You can open a support
                ticket for privacy-related matters.
            </li>
            <li class="self-stretch justify-start text-stone-400 text-base font-medium leading-normal">
                <span class="font-bold text-stone-300">Email Contact</span>:
                Send your inquiries to <a
                        href="mailto:support@megatrader.io"
                        class="text-[#ffb54d]">support@megatrader.io</a> with the subject line &quot;Privacy
