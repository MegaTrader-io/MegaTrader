<section id="feature-trusted-by-leadres" class="space-y-12 pb-12 px-4">
    <div class="w-full space-y-4">
        ...
        <div
                class="mx-auto max-w-[612px] text-center text-xl leading-8 font-medium text-stone-400 md:max-w-[860px]">
    ...
    <div class="space-y-12 md:flex md:gap-12 md:space-y-0">
        <div class="mgt-card space-y-8 !p-8">
            <div class="flex items-center gap-4">
                ...
                <div
                        class="justify-start text-white text-xl font-bold leading-8">
                    MegaTraderX
                </div>
            </div>

            <div
                    class="justify-start text-stone-400 text-base font-medium leading-6">
            ...
            <div class="flex items-center gap-4">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/landing-page/avatar-angela.png"
                     alt="avatar Angela Kim, United States" height="64" width="64"/>

                <div>
                    <div
                            class="self-stretch justify-start text-white text-base font-medium leading-6">
                        Angela
                        Kim, United States
                    </div>
                    <div
                            class="self-stretch justify-start text-stone-400 text-base font-medium leading-6">United
                        State
                    </div>
                </div>
            </div>
        ...
        <div class="mgt-card space-y-8 !p-8">
            ...
            <div class="flex items-center gap-4">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/landing-page/avatar-daniel.png"
    ...
    <div class="mgt-card space-y-8 !p-8">
        ...
        <div
                class="self-stretch justify-start text-white text-xl font-medium leading-8">The
        ...
        <div class="flex items-center gap-4">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/landing-page/avatar-michael.png"
                 alt="avatar Daniel Reyes" height="64" width="64"/>
