...
<?php
    ...
    function render_account_sizes($account_sizes) {
        ...
        foreach ($account_sizes as $index => $size) {
            ...
            $is_active = $index === 0 ? ' active' : '';
            $on_sale = $index === 0 ? ' on-sale' : ''; // TODO: what determines OnSale?

            ?>
            <div data-value="<?= $slug ?>" id="<?= $slug ?>" class="button<?= $on_sale . $is_active ? $on_sale . $is_active : '' ?>">
                <img src="<?= $thumbnail ?>" alt="Icon" width="57" height="57">
                <span class="content">
                ...
                <div class="col-lg-7">
                    <div class="variation-list">
                        <div class="account-items">
                            <h6 class="fw-light text-size-20 text-uppercase text-white">Select your TRADING platform</h6>
