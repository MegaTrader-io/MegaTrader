                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="w-full">
                                <div className="flex items-center gap-2">
                                    ...
                                    <div
                                        className="text-white text-base font-normal leading-normal">
                                        Days with ${account.objectives.tradingDays.daysWithMinProfit.minProfit} profit
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="space-y-2">
                    <div className="flex gap-2">
                        ...
                        <div className="flex gap-4 w-full">
                            <div className="w-full">
                                <div className="gap-2">
                                    <div className="text-white text-base font-light lg:pr-8 pr-12">Reach and maintain
                                        the
                                        $9,000+ <span
                    ...
                    <div className="flex gap-2">
                        ...
                        <div>
                            <div>
                                <div className="text-white text-base font-light leading-normal">Best day cannot be
                                    greater
