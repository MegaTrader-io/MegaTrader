...
export const Select = forwardRef(function Select(
    ...
    return (
      ...
      <Headless.Select
          ...
          className={clsx([
              // Basic layout
              'text-neutral-50 text-base h-12 pl-4 pr-3 py-3 bg-stone-800 rounded-xl border border-neutral-700 justify-center items-center gap-2 inline-flex appearance-none',
              // Horizontal padding
              multiple
