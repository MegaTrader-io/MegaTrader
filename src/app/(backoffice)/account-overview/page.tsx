                ...
                <div className="space-y-2">
                    <div className="w-full flex justify-center">
                        <svg width="443" height="126" viewBox="0 0 443 126" fill="none"
                            ...
                            <path d="M307.492 81.4551C318.992 82.6217 343.992 92.1551 351.992 120.955" stroke="#A78BFA"
                                  strokeWidth="4"/>
                            <path d="M407.525 63.8994C411.662 58.198 424.34 47.9463 441.962 52.5506" stroke="#FB923C"
                                  strokeWidth="4"/>
                            <path d="M12.5938 46.7812C18.202 51.0429 28.1698 63.9453 23.1754 81.4616" stroke="#FB7185"
                                  strokeWidth="4"/>
                            <path d="M129.305 58.5342C126.268 62.1436 117.308 68.3818 105.758 64.4597" stroke="#2DD4BF"
                                  strokeWidth="4"/>
                            <path
                                ...
                                fill="#14B8A6"/>
                            <mask id="mask0_5950_20310" style={{maskType: 'alpha'}} maskUnits="userSpaceOnUse" x="202"
