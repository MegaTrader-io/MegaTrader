...
export default async function Login() {
    ...
    //         <div className="grid grid-cols-[676px_1fr]">
    //             <div className="text-white w-[676px]">
    //                 <h1 className="text-white text-5xl font-light uppercase leading-[60px]">Sign
    //                     SIGN IN
    //                 </h1>
    //                 <h2
    ...
    //                 </Badge>
    //                 <p className="text-stone-400 text-base font-normal leading-normal">No minimum trading days on your
