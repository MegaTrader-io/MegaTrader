...
function ArrowDown({direction = 'desc', className = 'text-white'}: { direction: directionType, className?: string }) {
    ...
    return (
        <span className={className}>
            ...
            <g mask="url(#mask0_5635_21685)">
                <path d="M18 10L12 16L6 10L7.4 8.6L12 13.2L16.6 8.6L18 10Z" fill="currentColor"/>
            </g>
        </svg>
        </span>
    );
