...
const Layout = ({children}: { children: React.ReactNode }) => {
    ...
    return (
        <div className="m-4 xl:max-h-[calc(100dvh-32px)] xl:h-dvh xl:flex xl:flex-row flex-col">
            <div
                ref={divRef}
                className="mg-divRef flex h-full w-full flex-col justify-center py-12 sm:pr-6 md:h-auto lg:min-h-auto xl:w-2/5 xl:flex-none xl:pr-4 2xl:px-24">
            ...
            <div
                style={{height}}
                className="relative rounded-2xl pt-4 sm:pt-[60px] xl:pb-[32px] h-full lg:min-h-auto xl:h-auto md:px-[52px] lg:flex-1 md:block bg-[#1e1e1e] lg:overflow-hidden xl:flex flex-col">
                <div
