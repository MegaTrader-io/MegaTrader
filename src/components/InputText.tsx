            ...
            <div className="w-full">
                <div className="flex items-center relative">
                    <input
                        ...
                        className={`h-12 px-4 py-3 read-only:bg-stone-600 bg-[#1e1e1e]/70 disabled:bg-stone-600 disabled:text-stone-400 placeholder:text-neutral-700 rounded-xl border w-full font-medium focus:border-transparent text-base focus:outline-none focus:ring-1 ${
                            hasError
