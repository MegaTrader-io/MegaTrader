        ...
        >
            <Card
                ...
                <div className="relative z-10 w-full">
                    <h3 className="text-xl font-medium mb-4 text-white">{plan.level}</h3>
                    <div className="mb-6">
                        <span className={`text-5xl font-bold ${plan.color}`}>{plan.total_peer_year}</span>
                    </div>
                    <div className="mb-6">
                    <span
                        className={`text-3xl font-medium ${plan.color}`}>{plan.total_peer_month.split('/')[0]}</span>
                        <span className="text-gray-400 font-light">/MO</span>
                    </div>
