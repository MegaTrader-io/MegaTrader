 ...
 * - Modal #mt-feedback-modal en account-overview.php
 * - JS mt-account-overview.js (abre modal y guarda por AJAX)
 */
if (!defined('ABSPATH'))
  exit;
...
$rows = [
  ['openTime' => '2025-09-17T10:00:00.000Z', 'net' => -73.40, 'hi' => -1.00, 'lo' => -73.40, 'ct' => 70, 'fees' => 25.90, 'trades' => 4, 'awin' => 2.60, 'aloss' => 39.90, 'win' => 50.00, 'max' => '2/1', 'dur' => '00:05:05 00:01:17'],
  ['openTime' => '2025-09-16T10:00:00.000Z', 'net' => 45.10, 'hi' => 88.20, 'lo' => -5.25, 'ct' => 22, 'fees' => 12.20, 'trades' => 9, 'awin' => 18.00, 'aloss' => 9.50, 'win' => 62.50, 'max' => '3/1', 'dur' => '00:08:10 00:03:25'],
  ['openTime' => '2025-09-15T10:00:00.000Z', 'net' => -234.28, 'hi' => 6.90, 'lo' => -240.78, 'ct' => 158, 'fees' => 139.28, 'trades' => 22, 'awin' => 28.07, 'aloss' => 22.04, 'win' => 22.73, 'max' => '2/12', 'dur' => '00:06:09 00:04:42'],
  ['openTime' => '2025-09-14T10:00:00.000Z', 'net' => 120.50, 'hi' => 160.10, 'lo' => -8.40, 'ct' => 11, 'fees' => 6.80, 'trades' => 5, 'awin' => 42.30, 'aloss' => 15.60, 'win' => 66.67, 'max' => '4/1', 'dur' => '00:04:20 00:02:10'],
  ['openTime' => '2025-09-13T10:00:00.000Z', 'net' => -15.75, 'hi' => 20.00, 'lo' => -30.40, 'ct' => 33, 'fees' => 9.99, 'trades' => 7, 'awin' => 10.15, 'aloss' => 11.30, 'win' => 42.86, 'max' => '2/2', 'dur' => '00:03:50 00:02:40'],
  ['openTime' => '2025-09-12T10:00:00.000Z', 'net' => 90.00, 'hi' => 120.00, 'lo' => -2.10, 'ct' => 40, 'fees' => 19.10, 'trades' => 8, 'awin' => 25.50, 'aloss' => 10.40, 'win' => 62.50, 'max' => '3/1', 'dur' => '00:07:33 00:03:01'],
];
...
if (isset($args) && is_array($args)) {
  if (isset($args['meta']['accountId']))
    $acc_id = (int) $args['meta']['accountId'];
  elseif (isset($args['accountId']))
    $acc_id = (int) $args['accountId'];
}
if (!$acc_id && isset($current_account_id))
  $acc_id = (int) $current_account_id;
if (!$acc_id)
  $acc_id = (int) get_user_meta($user_id, 'mt_current_account_id', true);

?>
<div id="<?php echo esc_attr($root_id); ?>" data-per-page="<?php echo (int) $per_page; ?>"
  data-account-id="<?php echo (int) $acc_id; ?>" class="mt-card">
      ...
      <div class="dj-scroll">
        ...
        <?php foreach ($rows as $i => $r):
          ...
          $net_class = isset($r['net'])
            ...
            : '';
          ?>
          <div class="dj-grid dj-row" id="dj-row-<?php echo esc_attr($day_iso); ?>"
            data-page="<?php echo esc_attr($page); ?>" <?php echo $hidden; ?>
            data-trade-date="<?php echo esc_attr($day_iso); ?>">
            <div class="dj-cell is-left">
              <span class="mt-dj-visibility" role="button" tabindex="0" aria-label="Add daily feedback"
            ...
            <div class="dj-cell is-right <?php echo esc_attr($net_class); ?>">
              <?php echo esc_html(mt_money_fmt($r['net'] ?? 0)); ?></div>
