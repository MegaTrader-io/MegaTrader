...
<script>
  ...
  // Si NO hay suficientes puntos, no inicializamos ApexCharts ni tocamos nodos del chart
  if (!hasEnoughPoints()) {
    // Nada más que hacer: el overlay ya quedó visible desde PHP
    // (Early return del script)
  } else {
