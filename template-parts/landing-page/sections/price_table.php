...
<div class="mega-info-row {$classes}">
    <div class="mega-info-row__icon_container">
        <img src="{$checkIconUrl}" width="24" height="24" alt="Check icon">
    </div>
    <div class="mega-info-row__content">
        <span class="mega-info-row__label">{$label}</span>:
        <span class="mega-info-row__value">{$value}</span>
    </div>
</div>
HTML;
}
    ...
    <div class="tw-block md:tw-hidden tw-justify-center">
        ...
        <div class="tw-w-full tw-flex tw-justify-center">
            <p class="tw-mx-5 tw-w-[362px] tw-mb-0 tw-text-center tw-justify-start text-stone-400 tw-text-lg tw-font-normal tw-leading-6 tw-tracking-tight">
                Choose from flexible account sizes and plans tailored to your style—whether you're learning or ready to trade with confidence.
            </p>
        </div>
    </div>
