...
<div class="mt-my-profile <?= esc_attr($collapsed_class); ?>">
        ...
        <div class="my-account-logout">
            <a href="<?php echo esc_url($logout_url); ?>" class="logout-link" aria-label="Logout">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <mask id="mask0_12101_26191" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                          width="24"
                          height="24">
    ...
    <?php else: ?>
        ...
        <div class="mt-my-profile__notifications" data-mt-ajax="<?php echo esc_url(admin_url('admin-ajax.php')); ?>"
            ...
            <a id="mt-notifications-toggle" class="mt-sidebar__menu__link" href="javascript:void(0)"
