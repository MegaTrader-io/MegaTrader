...
if (isset($order) && $order && !$order->has_status('failed')):
    ...
    ?>
    <!-- Modal -->
    <div class="modal fade" id="orderSuccessModal" tabindex="-1" aria-labelledby="orderSuccessLabel" aria-hidden="true" data-overview-url="https://subscriptions.megatrader.io/my-account/overview/">
