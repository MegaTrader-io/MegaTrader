...
<?php elseif($step === 2): ?>
    ...
    <div class="w-100 d-flex justify-content-between align-items-center pb-32 m-auto w-max-600px gap-2">
        <div class="d-flex gap-2 align-items-center">
            <a href="<?php echo esc_url(home_url('/select-plan')); ?>" class="actived">
            ...
            <div class="text-base text-primary fw-medium d-none d-md-block">Select Plan</div>
        </div>
        ...
        <div class="d-flex gap-2 align-items-center">
            ...
            <div class="text-white text-base fw-medium d-none d-md-block">Checkout</div>
        </div>
		<div class="step-selector__separator"></div>
        <div class="step-selector__step step-future">
            <div class="steps2">
...
<?php elseif($step === 3): ?>
    ...
    <div class="w-100 d-flex justify-content-between align-items-center pb-32 m-auto w-max-600px gap-2">
        ...
        <div class="d-flex gap-2 align-items-center">
			...
			<div class="text-base text-primary fw-medium d-none d-md-block">Checkout</div>
        </div>
		<div class="bg-404040 flex-fill h-2px"></div>
		<div class="d-flex gap-2 align-items-center">
            <div class="bg-mgt-primary border-mgt-primary h-32px overflow-hidden rounded-64px w-32px position-relative">
            ...
            <div class="text-white text-base fw-medium d-none d-md-block">Confirmation</div>
        </div>
    </div>
