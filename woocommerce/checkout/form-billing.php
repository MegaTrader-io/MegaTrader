...
<div class="mb-0">
	...
	<div class="line-input-no row gap-3 <?php if ( ! is_user_logged_in() ) : ?>pt-32<?php endif; ?>">
            ...
            <div class="row row-gap-3">
                <div class="col-lg-6">
                    <div class="form-group no-label">
                        <label class="label" for="billing_first_name"><?php esc_html_e( 'First Name', 'megatrader' ); ?>*</label>
                        <input type="text" class="form-control" name="billing_first_name" id="billing_first_name" placeholder="<?php esc_attr_e( 'First Name', 'megatrader' ); ?>" value="<?php echo esc_attr( $checkout->get_value( 'billing_first_name' ) ); ?>">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group no-label">
                        <label class="label" for="billing_last_name"><?php esc_html_e( 'Last Name', 'megatrader' ); ?>*</label>
                        <input type="text" class="form-control" name="billing_last_name" id="billing_last_name" placeholder="<?php esc_attr_e( 'Last Name', 'megatrader' ); ?>" value="<?php echo esc_attr( $checkout->get_value( 'billing_last_name' ) ); ?>">
                    </div>
                </div>
            </div>
            <div class="form-group no-label">
                <label class="label" for="billing_email"><?php esc_html_e( 'Email Address', 'megatrader' ); ?>*</label>
                <input type="email" class="form-control" name="billing_email" id="billing_email" placeholder="<?php esc_attr_e( 'Enter your email', 'megatrader' ); ?>" value="<?php echo esc_attr( $checkout->get_value( 'billing_email' ) ); ?>">
            </div>
            <div class="form-group no-label">
        ...
        <div class="col-lg-12">
            <div class="form-group no-label">
                <label class="label" for="billing_address_2"><?php esc_html_e( 'Aparment, Suite, Unit, etc, (opcional)', 'megatrader' ); ?></label>
