...
?>
body {
	background: url(https://subscriptions.megatrader.io/wp-content/uploads/2025/05/dot-bg.png) 0% 0% / 5px 5px repeat, #131210;
	padding: 0;
	text-align: center;
	font-size: 14px;
    color: #a8a29e;
    font-family: 'Space Grotesk', Arial, 'Trebuchet MS', Helvetica, sans-serif;
    font-weight: 300;
}
