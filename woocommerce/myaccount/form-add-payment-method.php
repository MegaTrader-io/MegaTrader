		...
		<div id="payment" class="woocommerce-Payment d-flex flex-column gap-32">
			...
			<div class="form-row d-flex flex-column gap-3">
                ...
                <div class="d-flex gap-2">
                    <button type="button" class="modal-cancel mega-btn-md mega-btn-outline-md w-100" data-bs-dismiss="modal"><?php esc_html_e( 'CANCEL', 'megatrader' ); ?></button>
                    <button type="submit" class="mega-btn-md mega-btn-primary-md w-100" value="<?php esc_attr_e( 'Add payment method', 'woocommerce' ); ?>"><?php esc_html_e( 'Add payment method', 'megatrader' ); ?></button>
                </div>
